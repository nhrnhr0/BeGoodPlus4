...
from morders.views import api_edit_order_add_product, api_edit_order_delete_product, api_get_order_data, create_provider_docs, morders_create_providers_docx, dashboard_orders_collection_smartbee, edit_morder, get_all_orders, dashboard_orders_collection_collect_save, list_orders_to_collect, load_all_provider_request_admin, morder_edit_order_add_product_entries, api_delete_order_data_item, morder_edit_order_add_product_entries_2, morder_edit_order_add_provider_entries, provider_request_update_entry_admin, view_morder_pdf, view_morder_stock_document, spreedsheet_to_morder_view
