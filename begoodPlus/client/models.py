...
class Client(models.Model):
    ...
    def __str__(self):
        ...
        return ret
    businessName = models.CharField(verbose_name=_('business name '), max_length=120, blank=True, default='')
    email = models.EmailField(verbose_name=_('email'), max_length=120, blank=True, default='')
    ...
    tariff = models.FloatField(verbose_name=_('tariff (%)'), default=0)
    privateCompany = models.CharField(max_length=254, verbose_name=_('P.C.'), blank=True, default='')
    clientType = models.CharField(max_length=50, choices=CLIENT_TYPES, verbose_name=_('client type'), default=CLIENT_TYPE_ND)
    address = models.CharField(verbose_name=_('address'), max_length=511, blank=True, default='')
    contactMan = models.CharField(verbose_name=_('contact man'),max_length=100, blank=True, default='')
    contactManPosition = models.CharField(verbose_name=_('contact man position'), max_length=100, blank=True, default='')
    contactManPhone = models.CharField(verbose_name=_('contact man phone'),max_length=100, blank=True, default='')
