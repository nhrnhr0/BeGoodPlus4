...
class CatalogAlbumAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'title', 'topLevelCategory', 'render_cimage_thumbnail',
                    'slug', 'related_images_count', 'is_public')  # 'get_absolute_url')
