...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('inventory', '0031_auto_20220619_1322'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.IntegerField(default=0)),
                ('providerRequest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.providerrequest')),
            ],
        ),
        migrations.AddField(
            model_name='productenteritems',
            name='provider',
            field=models.ManyToManyField(to='inventory.ProviderRequestToEnter'),
        ),
    ]
