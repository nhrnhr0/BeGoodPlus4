    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = text("עריכה");
    			t15 = space();
    			attr_dev(td0, "class", "svelte-zwatol");
    			add_location(td0, file, 22, 16, 482);
    			attr_dev(td1, "class", "svelte-zwatol");
    			add_location(td1, file, 23, 16, 517);
    			attr_dev(td2, "class", "svelte-zwatol");
    			add_location(td2, file, 24, 16, 561);
    			attr_dev(td3, "class", "svelte-zwatol");
    			add_location(td3, file, 25, 16, 603);
    			attr_dev(td4, "class", "svelte-zwatol");
    			add_location(td4, file, 26, 16, 649);
    			attr_dev(td5, "class", "svelte-zwatol");
    			add_location(td5, file, 27, 16, 692);
    			attr_dev(td6, "class", "svelte-zwatol");
    			...
    			attr_dev(td7, "class", "svelte-zwatol");
    			add_location(td7, file, 29, 16, 780);
    			attr_dev(tr, "class", "svelte-zwatol");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(th0, "class", "svelte-zwatol");
    			add_location(th0, file, 9, 12, 143);
    			attr_dev(th1, "class", "svelte-zwatol");
    			add_location(th1, file, 10, 12, 168);
    			attr_dev(th2, "class", "svelte-zwatol");
    			add_location(th2, file, 11, 12, 196);
    			attr_dev(th3, "class", "svelte-zwatol");
    			add_location(th3, file, 12, 12, 231);
    			attr_dev(th4, "class", "svelte-zwatol");
    			add_location(th4, file, 13, 12, 257);
    			attr_dev(th5, "class", "svelte-zwatol");
    			add_location(th5, file, 14, 12, 286);
    			attr_dev(th6, "class", "svelte-zwatol");
    			add_location(th6, file, 15, 12, 320);
    			attr_dev(th7, "class", "svelte-zwatol");
    			...
    			attr_dev(table, "class", "enter-documents-table svelte-zwatol");
    			add_location(table, file, 6, 0, 65);
    			attr_dev(main, "class", "svelte-zwatol");
